...
using ICUDashboard.Sessions;
using ICUDashboard.Web.Controllers.Results;
using ICUDashboard.Web.Models;
using ICUDashboard.Web.Models.Account;
...
{
    public class AccountController : ICUDashboardControllerBase
    {
